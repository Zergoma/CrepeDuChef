...
{
    public class CrepePartyRepositoryInfrastructure : ICrepePartyRepositoryInfrastructure
    {
        private readonly IDbContextFactory<CrepeDbContext> _factory;

        public CrepePartyRepositoryInfrastructure(IDbContextFactory<CrepeDbContext> factory)
        {
            _factory = factory;
        }
